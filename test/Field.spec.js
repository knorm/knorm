        ...
        describe('type', function () {
            it('rejects with a FieldTypeError if an invalid value is set', async function () {
                ...
                await expect(
                    field.validate({}),
                    'to be rejected with',
                    new Field.errors.FieldTypeError("value is not of type 'text'", field, {}, 'text')
                );
            });
            ...
            describe('rejects for invalid types', function () {
                it("for fractions against the 'integer' type", async function () {
                    ...
                    await expect(
                        field.validate(1.5),
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'integer'", field, 1.5, 'integer')
                    );
                });
                ...
                it("for string numbers against the 'integer' type", async function () {
                    ...
                    await expect(
                        field.validate('1'),
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'integer'", field, '1', 'integer')
                    );
                });
                ...
                it("for date strings against the 'dateTime' type", async function () {
                    ...
                    await expect(
                        ...
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'dateTime'", field, dateString, 'dateTime')
                    );
                });
                ...
                it("for truthy values against the 'boolean' type", async function () {
                    ...
                    await expect(
                        field.validate(1),
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'boolean'", field, 1, 'boolean')
                    );
                });
                ...
                it("for falsy values against the 'boolean' type", async function () {
                    ...
                    await expect(
                        field.validate(0),
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'boolean'", field, 0, 'boolean')
                    );
                });
                ...
                it("invalid uuid's against the 'uuid' type", async function () {
                    ...
                    await expect(
                        ...
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'uuid'", field, 'not-valid-uuid', 'uuid')
                    );
                });
                ...
                it("uuid.v1 against the 'uuidV4' type", async function () {
                    ...
                    await expect(
                        ...
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'uuidV4'", field, uuidV1, 'uuidV4')
                    );
                });
                ...
                it("invalid json against the 'json' type", async function () {
                    ...
                    await expect(
                        ...
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'json'", field, '{not: "valid"}', 'json')
                    );
                });
                ...
                it("false against the 'json' type", async function () {
                    ...
                    await expect(
                        ...
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'json'", field, false, 'json')
                    );
                });
                ...
                it("strings against the 'decimal' type", async function () {
                    ...
                    await expect(
                        field.validate('foo'),
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'decimal'", field, 'foo', 'decimal')
                    );
                });
                ...
                it("string values against the 'binary' type", async function () {
                    ...
                    await expect(
                        field.validate('bar'),
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'binary'", field, 'bar', 'binary')
                    );
                });
                ...
                it("object values against the 'binary' type", async function () {
                    ...
                    await expect(
                        field.validate({}),
                        'to be rejected with',
                        new Field.errors.FieldTypeError("value is not of type 'binary'", field, {}, 'binary')
                    );
                });
            });
        });
        ...
        describe('maxLength', function () {
            it('rejects with a MaxLengthError if the value is longer than the maxLength', async function () {
                ...
                await expect(
                    ...
                    'to be rejected with',
                    new Field.errors.MaxLengthError('value is too long', field, '1234567', 6)
                );
            });
        ...
        describe('oneOf', function () {
            ...
            it('checks against the casing of strings', async function () {
                ...
                await expect(
                    field.validate('read'),
                    'to be rejected with',
                    new Field.errors.OneOfError('value is unexpected', field, 'read', [ 'READ', 'UNREAD' ])
                );
            });
        ...
        describe('with a custom validator', function () {
            ...
            it('rejects with a CustomValidatorError if the validator returns `false`', async function () {
                ...
                await expect(
                    field.validate('bar value'),
                    'to be rejected with',
                    new Field.errors.CustomValidatorError('value is invalid', field, 'bar value', function () {
                        return true;
                    })
                );
            });
            ...
            it('runs the new validators if the validator returns an object with validators', async function () {
                ...
                await expect(
                    field.validate('bar value'),
                    'to be rejected with',
                    new Field.errors.MaxLengthError('value is too long', field, 'bar value', 2)
                );
            });
