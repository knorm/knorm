class Options {
  ...
  from(from) {
    return this.setArrayOption('from', from);
  }

  qualifier(qualifier) {
    return this.setStringOption('qualifier', qualifier);
  }

  subquery(subquery = true) {
    return this.setBooleanOption('subquery', subquery);
  }
  ...
  select(select = true) {
    return this.setBooleanOption('select', select);
  }

  insert(insert = true) {
    return this.setBooleanOption('insert', insert);
  }

  update(update = true) {
    return this.setBooleanOption('update', update);
  }

  delete(_delete = true) {
    return this.setBooleanOption('delete', _delete);
  }
}
