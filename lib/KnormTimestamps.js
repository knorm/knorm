...
class KnormTimestamps {
  constructor(config = {}) {
    ...
    this.fields = {};
    this.fields[(createdAt && createdAt.name) || 'createdAt'] = {
      type: 'dateTime',
      column: (createdAt && createdAt.column) || 'created_at',
      default: () => new Date(),
      updated: false
    };
    this.updatedAtFieldName = (updatedAt && updatedAt.name) || 'updatedAt';
    this.fields[this.updatedAtFieldName] = {
      type: 'dateTime',
      column: (updatedAt && updatedAt.column) || 'updated_at',
      default: () => new Date()
    };
  }
