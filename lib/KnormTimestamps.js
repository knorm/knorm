...
class KnormTimestampsError extends KnormError {}
...
class KnormTimestamps {
  ...
  init(knorm) {
    if (!knorm) {
      throw new KnormTimestampsError('no Knorm instance provided');
    }

    if (!(knorm instanceof Knorm)) {
      throw new KnormTimestampsError('invalid Knorm instance provided');
    }
...
KnormTimestamps.KnormTimestampsError = KnormTimestampsError;
