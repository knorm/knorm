class Model {
    ...
    if (this._config.name !== this.name) {
      ...
      this._config = Object.assign(
        {},
        {
          ...
          referenced: Object.assign({}, this._config.referenced),
  ...
  static getReferenced() {
    this._inheritConfig();
    return this._config.referenced;
  }
  ...
  static setFields(fields) {
    ...
    Object.keys(fields).forEach(name => {
      ...
      this._config.fields[name] = new this.Field(
