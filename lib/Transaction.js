...
class Transaction {
  constructor(callback) {
    ...
    TransactionField.prototype.models = TransactionField.models = models;
    TransactionModel.prototype.models = TransactionModel.models = models;
    TransactionQuery.prototype.models = TransactionQuery.models = models;
    ...
    Object.entries(this.models).forEach(([name, model]) => {
      ...
      models[name].prototype.models = models[name].models = models;
      TransactionField.prototype.models = TransactionField.models = models;
      TransactionQuery.prototype.models = TransactionQuery.models = models;
    });
