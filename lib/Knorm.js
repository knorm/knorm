...
class Knorm {
  ...
  constructor(config = {}) {
    ...
    [Field, Model, Connection, Query, Sql, Transaction].forEach(scopedClass => {
   ...
   *
   * @param {Transaction} Transaction The new class, which may extend the
   ...
   *
   * @param {Model} Model The new class, which may extend the current
   ...
   * ensures all references to the new class are updated accordingly.
   *
   * @param {Field} Field The new class, which may extend the current
   ...
   * ensures all references to the new class are updated accordingly.
   *
   * @param {Query} Query The new class, which may extend the current
   ...
   * ensures all references to the new class are updated accordingly.
   *
   * @param {Sql} Sql The new class, which may extend the current
   ...
   * ensures all references to the new class are updated accordingly.
   *
   * @param {Connection} Connection The new class, which may extend the
