...
class Knorm {
   ...
   *
   * @param {object} [config={}] ORM configuration.
   * @param {function} config.fieldToColumn A function to convert all field-names
   * to column names, for example [snakeCase](https://lodash.com/docs/4.17.10#snakeCase).
   * @param {boolean} config.debug Whether or not to enable debug mode.
   *
   */
  constructor(config = {}) {
    this.plugins = {};
   ...
   *
   * @param {object|function} plugin The plugin to load. If passed as a function,
