...
class Query {
   ...
   *
   * @param {Options} Options The new class. This could be a class
   * that extends the current {@link Query.Options} class or an entirely
   * new class.
   *
  ...
  static updateOptions(Options) {
    /**
     * The {@link Options} class used by all {@link Query} instances.
     *
     * @type {Options}
     */
...
Query.updateOptions(require('./Options'));
