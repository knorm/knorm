...
class Query {
  ...
  prepareSelect(options) {
    ...
    // TODO: support `with`. in which case it becomes the pivot (instead of `select`)
  ...
  formatSelect(options) {
    ...
    return {
      // TODO: `text` instead of `sql`?
      sql: sql.formatSqlPart(select),
