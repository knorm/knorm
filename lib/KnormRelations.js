    ...
    class RelationsQuery extends Query {
      ...
      addJoin(type, joins, options) {
        ...
        joins.forEach(join => {
          ...
          // consider reverse references first to support self-referencing models
          const parsedReferences =
            thisReferences[join.model.name] || joinReferences[this.model.name];
