...
class Sql {
  ...
  // TODO: make all these static? probably yes, better for performance.
  // TODO: what about accesses to this.Model.Sql.SqlPart or this.Model.Query?
  // TODO: then, Model won't need Model.sql (but it might be nice to have)
  ...
  raw(value) {
    ...
    return new this.Model.Sql.SqlPart({ type: 'raw', value });
  }

  distinct(value) {
    return new this.Model.Sql.SqlPart({ type: 'distinct', value });
  }

  all(value) {
    return new this.Model.Sql.SqlPart({ type: 'all', value });
  }

  fields(value) {
    return new this.Model.Sql.SqlPart({ type: 'fields', value });
  }

  from() {
    return new this.Model.Sql.SqlPart({ type: 'from' });
  }

  not(value) {
    return new this.Model.Sql.SqlPart({ type: 'not', value });
  }

  any(value) {
    return new this.Model.Sql.SqlPart({ type: 'any', value });
  }

  some(value) {
    return new this.Model.Sql.SqlPart({ type: 'some', value });
  }

  exists(value) {
    return new this.Model.Sql.SqlPart({ type: 'exists', value });
  }

  equalTo(field, value) {
    return new this.Model.Sql.SqlPart({ type: 'equalTo', field, value });
  }

  notEqualTo(field, value) {
    return new this.Model.Sql.SqlPart({ type: 'notEqualTo', field, value });
  }

  greaterThan(field, value) {
    return new this.Model.Sql.SqlPart({ type: 'greaterThan', field, value });
  }

  greaterThanOrEqualTo(field, value) {
    return new this.Model.Sql.SqlPart({
  ...
  lessThan(field, value) {
    return new this.Model.Sql.SqlPart({ type: 'lessThan', field, value });
  }
  ...
  isNull(field) {
    return new this.Model.Sql.SqlPart({ type: 'isNull', field });
  }

  isNotNull(field) {
    return new this.Model.Sql.SqlPart({ type: 'isNotNull', field });
  }

  like(field, value) {
    return new this.Model.Sql.SqlPart({ type: 'like', field, value });
  }

  between(field, value) {
    return new this.Model.Sql.SqlPart({ type: 'between', field, value });
  }

  in(field, value) {
    return new this.Model.Sql.SqlPart({ type: 'in', field, value });
  }

  and(value) {
    return new this.Model.Sql.SqlPart({ type: 'and', value });
  }

  or(value) {
    return new this.Model.Sql.SqlPart({ type: 'or', value });
  }

  where(value) {
    return new this.Model.Sql.SqlPart({ type: 'where', value });
  }

  having(value) {
    return new this.Model.Sql.SqlPart({ type: 'having', value });
  }
  ...
  select(options = {}) {
    ...
    return new this.Model.Sql.SqlPart({ type: 'select', value });
  }

  into() {
    return new this.Model.Sql.SqlPart({ type: 'into' });
  }

  columns(value) {
    return new this.Model.Sql.SqlPart({ type: 'columns', value });
  }

  values(value) {
    return new this.Model.Sql.SqlPart({ type: 'values', value });
  }

  returning(value) {
    return new this.Model.Sql.SqlPart({ type: 'returning', value });
  }
  ...
  insert(options = {}) {
    ...
    return new this.Model.Sql.SqlPart({ type: 'insert', value });
  }
